...
<%--                    <label class="text" style="margin-left: 60px; display:none;" id="text-items">Sản phẩm</label>--%>
                    <input type="text" onfocus="publicMenu()" id="item" class="custom-input-data" placeholder="Tất cả" readonly style="display:none">
                ...
                <div>
                    <div>
                        <div>
                            ...
                            <input placeholder="${fullName}" disabled="disabled" value="${fullName}" class="custom-input-data" id="input-department">

                            <label style="margin-top: 30px; margin-right: 10px; margin-left: 20px;" class="text">Tên môi giới</label>
                            <input placeholder="${fullName}" disabled="disabled" value="${fullName}" class="custom-input-data" id="input-saleName">

                            <label style="margin-top: 30px; margin-right: 10px; margin-left: 20px;" class="text">Hrcode</label>
                            <input placeholder="${hrcode}" disabled="disabled" value="${hrcode}" class="custom-input-data" id="input-hrCode">
                            ...
                            <input placeholder="${sessionScope['role-memberships'][0].membershipType}" disabled="disabled" value="${sessionScope['role-memberships'][0].membershipType}" class="custom-input-data" id="input-role">
    ...
    <script src="<c:url value="/resources/js/revenue-report-staff.js" />" type="text/javascript"></script>
